...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Transaction> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "midas-core");
        ...
        configProps.put(JsonDeserializer.TYPE_MAPPINGS, "transaction:com.jpmc.midascore.foundation.Transaction");
